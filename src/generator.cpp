...
namespace maze {
	generator::generator(unsigned int length,unsigned int width,unsigned int height) : maze(length,std::vector<std::vector<cell>>(width,std::vector<cell>(height,cell()))) {}

	generator::generator() : generator(10,10,1) {
		generate();
	}
